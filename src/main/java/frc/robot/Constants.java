...
public final class Constants {
    ...
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.8255; // FIXME Measure and set trackwidth
    /**
    ...
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.546; // FIXME Measure and set wheelbase

    public static final int DRIVETRAIN_PIGEON_ID = 0; // FIXME Set Pigeon ID

    public static final int FRONT_LEFT_MODULE_DRIVE_MOTOR = 13; // FIXME Set front left module drive motor ID
    public static final int FRONT_LEFT_MODULE_STEER_MOTOR = 23; // FIXME Set front left module steer motor ID
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(226); 

    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 11; // FIXME Set front right drive motor ID
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 20; // FIXME Set front right steer motor ID
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(204); // FIXME Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(94); // FIXME Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(204); // FIXME Measure and set back right steer offset
